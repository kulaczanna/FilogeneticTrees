function [newDistanceMatrix] = calculateNewDistanceMatrix(lengthOfMatrix, minValueY, minValueX, distanceMatrixCopy, newDistanceMatrix)

    for row = 1 : 1 : lengthOfMatrix-1        
        for column = 1 : 1 : lengthOfMatrix - 1
                       if(row < minValueY)
                            if(column < minValueY)
