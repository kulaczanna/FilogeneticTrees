...
%                                 branchLengthMatrix(row, column) = distanceMatrixCopy(row, column);
                            elseif(column == minValueY)
                                newDistanceMatrix(row, column) = (distanceMatrixCopy(row, minValueY) + ...
                                    distanceMatrixCopy(row, minValueX)) / 2;
%                                 branchLengthMatrix(row, column) = (distanceMatrixCopy(row, minValueY) + ...
%                                     distanceMatrixCopy(row, minValueX)) / 2;
...
%                                 branchLengthMatrix(row, column) = distanceMatrixCopy(row, column + 1);
                            end
...
%                                 branchLengthMatrix(row, column) = (distanceMatrixCopy(minValueY, column + 1) + ...
%                                     distanceMatrixCopy(minValueX, column + 1)) / 2;
                            elseif(column > minValueY)
                                newDistanceMatrix(row, column) = (distanceMatrixCopy(minValueY, column) + ...
                                    distanceMatrixCopy(column, minValueX)) / 2;
%                                 branchLengthMatrix(row, column) = (distanceMatrixCopy(minValueY, column) + ...
%                                     distanceMatrixCopy(column, minValueX)) / 2;
                            end
...
%                                     branchLengthMatrix(row, column) = distanceMatrixCopy(row + 1, column + 1);
                                end
                            else
                                newDistanceMatrix(row, column) = distanceMatrixCopy(row, column);
%                                 branchLengthMatrix(row, column) = distanceMatrixCopy(row, column);
